...
@pytest.mark.parametrize("line,secret", [
    ("SECRET_KEY=supersecretvalue123", "supersecretvalue123"),
    ("API_KEY: abcdef123456", "abcdef123456"),
    ('client_secret = "ghp_EXAMPLE0000example0000example00000"', "ghp_EXAMPLE0000example0000example00000"),
    ("CASEHUB_INBOUND_HMAC_SECRET=deadbeefcafe1234", "deadbeefcafe1234"),
    ("password=hunter2hunter2", "hunter2hunter2"),
    ('AUTH_TOKEN="abc123def456ghi789"', "abc123def456ghi789"),
])
...
def test_jurisprudence_refused_without_source():
    ...
    m = MaestroLite(org_name="o cliente")
    res = asyncio.get_event_loop().run_until_complete(
        m.chat("Tem algum acórdão do STJ sobre usucapião?")
    )
