...
const SYSTEM_PROMPT = [
  ...
  "- PM2: whatsapp-bot (3001), casehub (8001), maestro",
  "- Bancos: PessoaDemoDB (3306), PostgreSQL (5432), Redis (6379)",
  "- Web: Nginx (80/443)",
  "- Codigo: ${process.env.APP_BASE_PATH || "/opt/casehub"}/{casehub,whatsapp-bot}",
  "",
