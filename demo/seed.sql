...
VALUES
    (100, 'demo-br-00000-00000', 'Escritório Modelo', 'escritorio-modelo', NULL, '#1a6b7a', '#23808c', 'demo@casehub.legal', 'America/Sao_Paulo', 'pt-BR', 'BRL', 'EM', 'enterprise', 50, 9999, true),
    (101, 'demo-us-00000-00000', 'Demo Immigration Firm', 'demo-immigration', NULL, '#1a56db', '#7c3aed', 'demo-us@casehub.legal', 'America/New_York', 'en', 'USD', 'DIF', 'enterprise', 50, 9999, true)
...
VALUES
    -- BR org (100)
    (100, 'demo@casehub.legal', 'Demo Admin', '$2b$12$AVSmp475TTneKrwzKJ5GV.vyPK5IX3Pa3or1awER03iLoBkTsTsjq', 'admin', true, false, NULL),
    ...
    -- Immigration org (101)
    (101, 'demo-us@casehub.legal', 'Demo Admin', '$2b$12$AVSmp475TTneKrwzKJ5GV.vyPK5IX3Pa3or1awER03iLoBkTsTsjq', 'admin', true, false, NULL),
    ...
    (101, 'paralegal@demo.casehub', 'PessoaDemo Garcia', '$2b$12$AVSmp475TTneKrwzKJ5GV.vyPK5IX3Pa3or1awER03iLoBkTsTsjq', 'paralegal', true, false, NULL)
...
VALUES
    (100, 'Empresa Demo Alfa Ltda', 'contato.alfa@example.com', '+55 (11) 5555-0101', NOW() - INTERVAL '45 days'),
    (100, 'PessoaDemo de Souza', 'pessoa_demo.souza@example.com', '(11) 99999-0000', NOW() - INTERVAL '30 days'),
    (100, 'Empresa Demo Beta S.A.', 'juridico.beta@example.com', '+55 (11) 5555-0102', NOW() - INTERVAL '60 days'),
    (100, 'Empresa Demo Gama ME', 'admin.gama@example.com', '+55 (11) 5555-0103', NOW() - INTERVAL '20 days'),
    (100, 'Carlos Alberto Mendes', 'carlos.mendes@example.com', '(11) 99999-0001', NOW() - INTERVAL '15 days'),
    (100, 'Empresa Demo Delta Ltda', 'juridico.delta@example.com', '+55 (11) 5555-0104', NOW() - INTERVAL '90 days'),
    (100, 'Ana Paula Ferreira', 'ana.ferreira@example.com', '(11) 99999-0002', NOW() - INTERVAL '10 days'),
    (100, 'Roberto Silva Santos', 'roberto.santos@example.com', '(11) 99999-0003', NOW() - INTERVAL '5 days'),
    (100, 'Empresa Demo Epsilon ME', 'contato.epsilon@example.com', '+55 (11) 5555-0105', NOW() - INTERVAL '75 days'),
    (100, 'Luciana Oliveira Costa', 'luciana.costa@example.com', '(11) 99999-0004', NOW() - INTERVAL '25 days')
ON CONFLICT DO NOTHING;

-- CLIENTS (Immigration — org 101)
INSERT INTO clients (org_id, name, email, phone, created_at)
VALUES
    (101, 'John Doe', 'john.doe@example.com', '+1 (555) 123-4567', NOW() - INTERVAL '30 days'),
    (101, 'PessoaDemo Silva', 'pessoa_demo.silva@example.com', '+1 (555) 234-5678', NOW() - INTERVAL '45 days'),
    (101, 'Ahmed Hassan', 'ahmed.h@example.com', '+1 (555) 345-6789', NOW() - INTERVAL '20 days'),
    (101, 'Priya Patel', 'priya.patel@example.com', '+1 (555) 456-7890', NOW() - INTERVAL '60 days'),
    (101, 'Wei Chen', 'wei.chen@example.com', '+1 (555) 567-8901', NOW() - INTERVAL '15 days')
ON CONFLICT DO NOTHING;
...
VALUES
    (100, 'Empresa Demo Alfa vs Estado de MG — Tributário', 'active', NOW() - INTERVAL '40 days', '0001234-56.2024.8.13.0145', 'Mandado de Segurança', '1ª Vara da Fazenda Pública', 'Juiz de Fora', 'TJMG', 'Instrução'),
    (100, 'PessoaDemo de Souza — Trabalhista', 'active', NOW() - INTERVAL '25 days', '0007890-12.2025.5.03.0037', 'Reclamação Trabalhista', '2ª Vara do Trabalho', 'Juiz de Fora', 'TRT3', 'Audiência designada'),
    (100, 'Empresa Demo Beta — Recurso TRF1', 'active', NOW() - INTERVAL '55 days', '0005678-34.2024.4.01.3801', 'Apelação', '3ª Turma', 'Brasília', 'TRF1', 'Recurso'),
    (100, 'Empresa Demo Gama — Previdenciário', 'active', NOW() - INTERVAL '18 days', '0003456-78.2025.8.13.0145', 'Ação Previdenciária', '1ª Vara Federal', 'Juiz de Fora', 'TJMG', 'Petição inicial'),
    ...
    (100, 'Empresa Demo Delta — Cível', 'active', NOW() - INTERVAL '80 days', '0004567-89.2024.8.13.0145', 'Ação de Cobrança', '3ª Vara Cível', 'Juiz de Fora', 'TJMG', 'Sentença'),
    ...
    (100, 'Empresa Demo Epsilon — Trabalhista', 'closed', NOW() - INTERVAL '70 days', '0002345-67.2024.5.03.0037', 'Reclamação Trabalhista', '1ª Vara do Trabalho', 'Juiz de Fora', 'TRT3', 'Transitado em julgado'),
...
VALUES
    ...
    (101, 'I-130 Family — PessoaDemo Silva', 'active', NOW() - INTERVAL '40 days', 'I-130'),
...
VALUES
    ...
    (100, 'Impugnação RPV — Empresa Beta', 'in_progress', NOW() - INTERVAL '5 days', NOW() + INTERVAL '3 days'),
    (100, 'Laudo Pericial — Empresa Alfa', 'in_progress', NOW() - INTERVAL '3 days', NOW() + INTERVAL '7 days'),
    (100, 'Contestação — Empresa Delta', 'in_progress', NOW() - INTERVAL '4 days', NOW() + INTERVAL '2 days'),
    -- Aguardando (blocked)
    (100, 'Docs Cliente — Empresa Gama', 'blocked', NOW() - INTERVAL '7 days', NOW() + INTERVAL '1 day'),
