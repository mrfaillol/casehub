#!/usr/bin/env python3
"""Expand I-130 with ALL official USCIS fields"""
...
I130_FIELDS = [
    ...
    ("2G. Petitioner Immigration Status", "p2_20_class_admission", "20. If LPR - Class of Admission", "text", False),
...
def update_i130():
    ...
    with engine.connect() as conn:
        ...
        conn.commit()
        print(f"I-130 updated: {len(I130_FIELDS)} fields")
