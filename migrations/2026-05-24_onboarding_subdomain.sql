...
-- Date: 2026-05-24
-- Purpose: Support self-service signup with auto-subdomain (example.casehub.legal),
...
-- brand (casehub/customer), environment, government (BR legal), inappropriate.
-- ---------------------------------------------------------------------------
INSERT INTO reserved_subdomains (slug, reason, notes) VALUES
    ...
    ('example-law', 'reserved_example', 'Example legal tenant'),
    ('demo-law', 'reserved_example', 'Example legal tenant'),
    ('sample-office', 'reserved_example', 'Example legal tenant'),
